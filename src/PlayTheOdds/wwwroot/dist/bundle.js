...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return MatchFormat; });
/* unused harmony export Site */
/* unused harmony export MatchStatus */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return WagerStatus; });
...
(function (MatchFormat) {
    MatchFormat[MatchFormat["None"] = 0] = "None";
    MatchFormat[MatchFormat["Bo1"] = 1] = "Bo1";
    MatchFormat[MatchFormat["Bo2"] = 2] = "Bo2";
    MatchFormat[MatchFormat["Bo3"] = 3] = "Bo3";
    MatchFormat[MatchFormat["Bo5"] = 4] = "Bo5";
    MatchFormat[MatchFormat["Bo7"] = 5] = "Bo7";
    MatchFormat[MatchFormat["Bo9"] = 6] = "Bo9";
})(MatchFormat || (MatchFormat = {}));
var Site;
(function (Site) {
    Site[Site["None"] = 0] = "None";
    Site[Site["VpGame"] = 1] = "VpGame";
})(Site || (Site = {}));
var MatchStatus;
...
(function (WagerStatus) {
    WagerStatus[WagerStatus["None"] = 0] = "None";
    WagerStatus[WagerStatus["Open"] = 1] = "Open";
    WagerStatus[WagerStatus["Live"] = 2] = "Live";
    WagerStatus[WagerStatus["Settled"] = 3] = "Settled";
    WagerStatus[WagerStatus["Canceled"] = 4] = "Canceled";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_enums__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_vpGame__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_timespan__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__viewModels_matchViewModel__ = __webpack_require__(7);
...
class MainViewModel {
    constructor() {
        ...
        this.lastRefreshAgo = __WEBPACK_IMPORTED_MODULE_0_knockout__["observable"]();
    ...
    loadMatches() {
        __WEBPACK_IMPORTED_MODULE_2__api_vpGame__["a" /* Loader */].getMatchesAsync().then(matches => {
            // clear current
            this.matches().forEach(m => m.dispose());
            this.matches.removeAll();
            // push new
            matches.forEach(m => this.matches.push(new __WEBPACK_IMPORTED_MODULE_4__viewModels_matchViewModel__["a" /* default */](m)));
            // apply filter
    ...
    initFilter() {
        this.filter[__WEBPACK_IMPORTED_MODULE_1__models_enums__["a" /* Category */][__WEBPACK_IMPORTED_MODULE_1__models_enums__["a" /* Category */].Basketball]] = true;
        this.filter[__WEBPACK_IMPORTED_MODULE_1__models_enums__["a" /* Category */][__WEBPACK_IMPORTED_MODULE_1__models_enums__["a" /* Category */].Csgo]] = true;
        this.filter[__WEBPACK_IMPORTED_MODULE_1__models_enums__["a" /* Category */][__WEBPACK_IMPORTED_MODULE_1__models_enums__["a" /* Category */].Dota2]] = true;
        this.filter[__WEBPACK_IMPORTED_MODULE_1__models_enums__["a" /* Category */][__WEBPACK_IMPORTED_MODULE_1__models_enums__["a" /* Category */].Soccer]] = true;
        this.filter[__WEBPACK_IMPORTED_MODULE_1__models_enums__["a" /* Category */][__WEBPACK_IMPORTED_MODULE_1__models_enums__["a" /* Category */].Tennis]] = true;
    ...
    startMatchLoading() {
        ...
        setInterval(() => {
            this.loadMatches();
        }, __WEBPACK_IMPORTED_MODULE_3__shared_timespan__["a" /* default */].fromSeconds(30));
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shared_ajax__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_models__ = __webpack_require__(5);
...
class Loader {
    ...
    static mapToMatch(m) {
        const match = new __WEBPACK_IMPORTED_MODULE_1__models_models__["a" /* Match */]();
    ...
    static mapToWager(w) {
        const wager = new __WEBPACK_IMPORTED_MODULE_1__models_models__["b" /* Wager */]();
    ...
    static mapToTeam(t) {
        const team = new __WEBPACK_IMPORTED_MODULE_1__models_models__["c" /* Team */]();
...
/* harmony export (immutable) */ __webpack_exports__["c"] = Team;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_knockout___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_knockout__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_enums__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_timespan__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__wagerViewModel__ = __webpack_require__(8);
...
class WagerViewModel {
    constructor(wager, teamLeft, teamRight) {
        this.wager = wager;
        this.teamLeft = teamLeft;
        this.teamRight = teamRight;
        this.formattedStatus = __WEBPACK_IMPORTED_MODULE_0_knockout__["observable"]();
        this.initFormattedDate();
    }
    get oddLeft() {
    ...
    get status() {
        return __WEBPACK_IMPORTED_MODULE_1__models_enums__["b" /* WagerStatus */][this.wager.status];
    }
    get handicap() {
        if (!this.hasHandicap) {
            return "";
    ...
    initFormattedDate() {
        if (this.wager.status === __WEBPACK_IMPORTED_MODULE_1__models_enums__["b" /* WagerStatus */].Open) {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = WagerViewModel;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_knockout__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_knockout___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_knockout__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__viewModels_mainViewModel__ = __webpack_require__(3);
